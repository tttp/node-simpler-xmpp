...
exports.testError = function(test) {
	...
	var stanza = new ltx.Element('message', { to: 'hello@gmail.com', type: 'chat' });
    stanza.c('body').t('hi');
...
exports.testOnBuddyAway = function(test) {
	...
	conn.reset();
	var from = 'hello@gmail.com';
	var stanza = new ltx.Element('presence', { from: from + '/dsd'});
...
exports.testOnBuddyOffline = function(test) {
	...
	conn.reset();
	var from = 'hello@gmail.com';
	var stanza = new ltx.Element('presence', { from: from + '/dsd', type: 'unavailable'});
